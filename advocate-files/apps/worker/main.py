...
# Import routers
from endpoints import documents, ocr, embeddings, health, extract, ingest, review
...
app.include_router(ingest.router, prefix="/api/ingest", tags=["Knowledge Base"])
app.include_router(review.router, prefix="/api/review", tags=["Document Review"])
