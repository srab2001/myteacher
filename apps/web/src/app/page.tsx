    ...
    <div className={styles.container}>
      <main className={styles.main}>
        <div className={styles.hero}>
          <h1 className={styles.title}>MyTeacher</h1>
          <p className={styles.subtitle}>
            Special Education Teacher Portal
          </p>
          <p className={styles.description}>
            Manage student records, IEPs, 504 plans, and track student progress
            all in one place.
          </p>
        ...
        <div className={styles.features}>
          ...
          <div className={styles.feature}>
            ...
            <p>Create and manage IEPs, 504 plans, and behavior plans</p>
          </div>
          <div className={styles.feature}>
            <h3>Progress Tracking</h3>
            <p>Monitor student status across academic, behavior, and services</p>
          </div>
        </div>
      </main>
    </div>
