...
| 1.7 | 2026-02 | Verified full separation: separate Vercel projects, Neon databases, no cross-refs |
| 1.8 | 2026-02 | Admin knowledge base tool: upload/parse documents, manage KB for Q&A |
...
| GET | `/api/admin/documents` | List knowledge base documents with chunk/embedding stats |
| POST | `/api/admin/documents` | Create document from text (sends to worker for chunking/embedding) |
| POST | `/api/admin/documents/upload` | Upload PDF/TXT/DOCX, extract text, ingest into KB |
| GET | `/api/admin/documents/[id]` | Get document detail with chunks |
| DELETE | `/api/admin/documents/[id]` | Delete document and chunks |

### Advocate Admin Pages

| Path | Description |
|------|-------------|
| `/admin/documents` | Knowledge base management: upload/paste documents, view/delete, filter by source type |
